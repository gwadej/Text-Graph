...
$dset = Text::Graph::DataSet->new( { a => 1, bb => 2, cac => 3, dd => 4 }, [qw/bb a dd/] );
...
$dset = Text::Graph::DataSet->new( { a => 1, bb => 2, cac => 3, dd => 4 }, sort => undef );
...
eval { $dset = Text::Graph::DataSet->new( 10 ); };
